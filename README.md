...
Option Explicit  'Forces the explicit declaration of all the variables in a script.
    ...
    Dim Const_ChannelName2    '2015/01/21#ryousyou tou#14回目(桧山4号) 250番目のデータからチャンネル数が6つから7つになっているので、もう一つ配列を用意する
    Dim  Const_SampleHz       'サンプリングする周波数、名簿に合わせて周波数をセットする必要がある
    Dim  Const_SampleHz2      '2015/01/21#ryousyou tou#14回目(桧山4号) 250番目のデータからチャンネル数が6つから7つになっているので、もう一つ配列を用意する
    Dim  Const_TakeTime       'サンプリングする時間、サンプリングの終わり時間を指定(0～αまで)
    Dim  Const_TakeTime2      '2015/01/21#ryousyou tou#14回目(桧山4号) 250番目のデータからチャンネル数が6つから7つになっているので、もう一つ配列を用意する
    Dim  Const_MaxLength      'サンプリングする最大の長さ
    Dim  Const_MaxLength2     '2015/01/21#ryousyou tou#14回目(桧山4号) 250番目のデータからチャンネル数が6つから7つになっているので、もう一つ配列を用意する
    Dim  Const_WaveXForm      'WaveXFormきざみ
    Dim  Const_WaveXForm2     '2015/01/21#ryousyou tou#14回目(桧山4号) 250番目のデータからチャンネル数が6つから7つになっているので、もう一つ配列を用意する
    Dim Const_CopyChName      'コピーするチャンネルの名前
    ''サンプリングするチャンネルの名簿の値をセットする
    ' 2014/12/26 桧山用設定に変更　①～⑤主軸　⑥高速軸　⑦中速軸　⑭回転数
    ' 2015/01/29#ryousyou tou#桧山1-4redraw
    'Const_ChannelName = array( _
    '"圧電1","圧電2","圧電3","圧電4","圧電5","圧電6","圧電7","圧電8","圧電9", "ｻｰﾎﾞﾅｾﾙNS","ｻｰﾎﾞﾅｾﾙEW","ｻｰﾎﾞﾀﾜｰNS","ｻｰﾎﾞﾀﾜｰEW","回転計")
    const_channelName2 = array( _
    "圧電1","圧電2","圧電3","圧電4","圧電5","圧電6","回転計")
    const_channelName= array( _
    "圧電1","圧電2","圧電3","圧電4","圧電5","圧電6","圧電7","回転計")

    'サンプリングする周波数の値のセット
    '                        ①    ②    ③　　④    ⑤　  ⑥　  ⑦    ⑧   ⑨    NS    EW    NS    EW   RPM　　
    'Const_SampleHz = array( 0100, 0100, 0100, 0100, 0100, 4000, 1000, 400, 4000, 0050, 0050, 0050, 0050, 0100 )
    '                        ①    ②    ③　　④    ⑤　  ⑥　  RPM　　
    Const_SampleHz2 = array( 0100, 0100, 0100, 0100, 0100, 4000, 0100)
    '                         ①    ②    ③　　④    ⑤　  ⑥　  ⑦    RPM　　
    Const_SampleHz = array( 0100, 0100, 0100, 0100, 0100, 4000, 1000, 0100)
    
    'サンプリングする時間の値のセット
    '                         ①     ②    ③      ④     ⑤     ⑥      ⑦    ⑧     ⑨     NS    EW    NS    EW    RPM　　
    'Const_TakeTime = array( 032.0, 032.0, 032.0, 032.0, 032.0,  001.6, 006.4, 0016, 001.6,  64.0, 64.0, 64.0, 64.0,  64.0 )
    '                         ①     ②    ③      ④     ⑤     ⑥    RPM　　
    Const_TakeTime2 = array( 032.0, 032.0, 032.0, 032.0, 032.0,  001.6, 64.0 )
    '                          ①     ②    ③      ④     ⑤     ⑥     ⑦    RPM　　
    Const_TakeTime = array( 032.0, 032.0, 032.0, 032.0, 032.0,  001.6, 006.4, 64.0 )
    '                         ①    ②    ③　　④    ⑤　  ⑥　  ⑦    ⑧   ⑨    NS    EW    NS    EW   RPM　
    ...
    '                         ①    ②    ③　　④    ⑤　  ⑥　  RPM　
    Const_MaxLength2 = array( 1600, 1600, 1600, 1600, 1600, 3200, 3200)
    '                          ①    ②    ③　　④    ⑤　  ⑥　  ⑦　  RPM　
    Const_MaxLength = array( 1600, 1600, 1600, 1600, 1600, 3200, 3200, 3200)

    '                            ①       ②      ③　　   ④       ⑤　    ⑥　   ⑦     ⑧      ⑨     NS     EW     NS     EW    RPM　
    'Const_WaveXForm  = array( 0.03125, 0.03125, 0.03125, 0.03125, 0.03125, 0.625, 0.15625, 0.625, 0.625, 0.625, 0.625, 0.625, 0.625, 0.015625 )
    '                            ①       ②       ③　　   ④       ⑤　    ⑥　   RPM　
    Const_WaveXForm2  = array( 0.03125, 0.03125, 0.03125, 0.03125, 0.03125, 0.625, 0.015625 )
    '                             ①       ②       ③　　   ④       ⑤　    ⑥　   ⑦　    RPM　
    Const_WaveXForm  = array( 0.03125, 0.03125, 0.03125, 0.03125, 0.03125, 0.625, 0.15625, 0.015625 )
